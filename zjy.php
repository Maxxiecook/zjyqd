                ...
                foreach($inClassInfo as $n){
                    if ($n["DataType"] == "签到" and $n["State"] !== "3"){
                        ...
                        if($attendInfo["isAttend"] != "1"){
                            ...
                            @$url8="";//qq推送方式自己写
							@$url19="https://sc.ftqq.com/'{$sckey}'.send?text='{$test}'";
							$url20="";
							...
							if($qq!=''){
								...
								$output=file_get_contents($url9);
							}else{
								$output=file_get_contents($ur20);
							}
...
";
                        ...
                        if($n["DataType"] == "签到"){
                            echo  "状态:".$output['code']."账号:".$userName."的".$n['DateCreated'].$i["courseName"]."的签到已经签到!"."
";
